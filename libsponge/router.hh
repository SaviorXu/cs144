...
struct RouterElem{
    ...
    RouterElem(const uint32_t x,const uint8_t y,const std::optional<Address> z,const size_t w):route_prefix(x),prefix_length(y),next_hop(z),interface_num(w)
    {}
};
...
class Router {
    ...
    std::vector<RouterElem> RouterVec{};
